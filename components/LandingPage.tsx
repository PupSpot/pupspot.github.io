  ...
  <div className="bg-gradient-to-b from-blue-50 to-white h-screen flex items-center pt-16">
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <motion.div initial="initial" animate="animate" variants={staggerContainer} className="text-center">
        ...
        <motion.h1 variants={fadeIn} className="text-5xl md:text-6xl font-bold text-blue-900 mb-6">
          Where Dogs Make Friends
        </motion.h1>
        <motion.p variants={fadeIn} className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
  ...
  <div className="py-16 bg-white">
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} variants={staggerContainer}>
        ...
        <motion.p variants={fadeIn} className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
...
const CTASection = () => (
  <div className="bg-gradient-to-r from-blue-600 to-blue-700 py-16">
    <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} variants={staggerContainer} className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      <motion.h2 variants={fadeIn} className="text-3xl font-bold text-white mb-6">
        Ready to Join the Pack?
      </motion.h2>
      <motion.p variants={fadeIn} className="text-blue-100 mb-8 text-lg">
