  ...
  <div className="bg-gradient-to-b from-blue-50 to-white h-screen flex items-center">
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        >
          Join the community of dog lovers. Connect, share, and explore with
          your furry friends.
        </motion.p>
        <motion.div
          variants={fadeIn}
  ...
  <div className="py-16 bg-white">
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        >
          Discover all the amazing features that make PupSpot the perfect
          platform for you and your furry friend.
        </motion.p>
        <motion.div
          variants={staggerContainer}
          ...
          {[
            {
              ...
              title: "Dog Community",
              description:
                "Connect with local dog owners and arrange playdates",
              link: "/events",
            },
            {
              ...
              title: "Find Spots",
              description:
                "Discover dog-friendly parks, cafes, and more nearby",
              link: "/discover",
            },
            {
            ...
            },
            {
              ...
              title: "Pet Profiles",
              description:
                "Create profiles for your dogs and share their adventures",
              link: "/settings/pets",
            },
          ].map((feature, index) => (
            <motion.div
  ...
  <div className="bg-gradient-to-r from-blue-600 to-blue-700 py-16">
    ...
    >
      ...
      <motion.p variants={fadeIn} className="text-blue-100 mb-8 text-lg">
        Start connecting with dog lovers in your area and create pawsome
        memories!
      </motion.p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link
                href="mailto:support@pupspot.com"
            ...
            <li>
              <Link href="/privacypolicy" className="hover:text-blue-400">
                Privacy Policy
              </Link>
            </li>
            <li>
